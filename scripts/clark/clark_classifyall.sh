...
for i in ${inputfile} ; do
    ...
    bsub -q bio -o clarkbsubsummarylog_${sampleID}.txt "/home/stoopvdr/.conda/envs/CLARK/opt/clark/exe/getAbundance -F ${i} -D ${database}>${outputfolder}/cla_${sampleID}_report.csv" 
